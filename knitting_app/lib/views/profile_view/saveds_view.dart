...
class SavedsView extends StatefulWidget {
  const SavedsView({super.key});

  @override
  State<SavedsView> createState() => _LikedsViewState();
}

class _LikedsViewState extends State<SavedsView> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWidget(title: 'Kaydedilenler'),
      body: ListView(
        children: [
          SizedBox(height: 15),
