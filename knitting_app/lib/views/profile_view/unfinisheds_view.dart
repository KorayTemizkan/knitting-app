...
class UnfinishedsView extends StatefulWidget {
  const UnfinishedsView({super.key});

  @override
  State<UnfinishedsView> createState() => _LikedsViewState();
}

class _LikedsViewState extends State<UnfinishedsView> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWidget(title: 'Yarım Bıraktıklarım'),
      body: ListView(
        children: [
          SizedBox(height: 15),
